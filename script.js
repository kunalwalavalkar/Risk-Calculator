...
function calc_score() {
	...
	var impactScore = 0;
	var dataset = [];
	var threatAgentScore = parseInt(document.getElementById("sl").value) + parseInt(document.getElementById("motive").value) + parseInt(document.getElementById("oppor").value) + parseInt(document.getElementById("size").value);
	var vulnerabilityScore = parseInt(document.getElementById("eod").value) + parseInt(document.getElementById("eoe").value) + parseInt(document.getElementById("aware").value) + parseInt(document.getElementById("intrude").value) + 0;
	...
	if(likelihoodScore < 1) {
		s3.className = "";
		s3.classList.add("btn");
		s3.classList.add("green");
		score_LS = 0;
	} else if(likelihoodScore >= 1 && likelihoodScore < 3) {
		s3.className = "";
		s3.classList.add("btn");
		s3.classList.add("brightgreen");
		score_LS = 0;
	} else if(likelihoodScore >= 3 && likelihoodScore < 5) {
		s3.className = "";
		s3.classList.add("btn");
		s3.classList.add("yellow");
		score_LS = 1;
	} else if(likelihoodScore >= 5 && likelihoodScore < 6) {
		s3.className = "";
		s3.classList.add("btn");
		s3.classList.add("orange");
		score_LS = 1;
	} else if(likelihoodScore >= 6 && likelihoodScore < 8) {
		s3.className = "";
		s3.classList.add("btn");
		s3.classList.add("brightorange");
		score_LS = 2;
	} else {
		s3.className = "";
		s3.classList.add("btn");
	...
	var technicalImpactScore = parseInt(document.getElementById("loc").value) + parseInt(document.getElementById("loi").value) + parseInt(document.getElementById("loa").value) + parseInt(document.getElementById("loacc").value);
	var businessImpactScore = parseInt(document.getElementById("finan").value) + parseInt(document.getElementById("reput").value) + parseInt(document.getElementById("comply").value) + parseInt(document.getElementById("privacy").value) + 0;
	...
	if(impactScore < 1) {
		...
		score_IS = 2;
	} else if(impactScore >= 3 && impactScore < 5) {
		s6.className = "";
		s6.classList.add("btn");
		s6.classList.add("brightyellow");
		score_IS = 1;
	} else if(impactScore >= 5 && impactScore < 6) {
		s6.className = "";
		s6.classList.add("btn");
		s6.classList.add("orange");
		score_IS = 1;
	} else if(impactScore >= 6 && impactScore < 8) {
		s6.className = "";
		s6.classList.add("btn");
		s6.classList.add("brightorange");
		score_IS = 0;
	} else {
		s6.className = "";
		s6.classList.add("btn");
